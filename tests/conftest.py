...
def sample_products_df():
    ...
    return pd.DataFrame({
        ...
        "source_platform": ["shopify", "shopify", "woocommerce", "shopify", "shopify"],
...
def sample_clustering_stats():
    ...
    return {
        "kmeans": {
            ...
            "clusters": [
                {"cluster_kmeans": 0, "nb_produits": 386, "prix_moyen": 51.2,
                 "note_moyenne": 4.6, "remise_moy": 12.0},
                {"cluster_kmeans": 1, "nb_produits": 427, "prix_moyen": 42.0,
                 "note_moyenne": 4.7, "remise_moy": 40.0},
                {"cluster_kmeans": 2, "nb_produits": 417, "prix_moyen": 169.0,
                 "note_moyenne": 4.75, "remise_moy": 1.6},
                {"cluster_kmeans": 3, "nb_produits": 346, "prix_moyen": 65.0,
                 "note_moyenne": 4.4, "remise_moy": 16.0},
            ],
        },
        "dbscan": {
            "nb_anomalies": 106,
